...
<script type="text/javascript">
   function realTimeWeather(x,y,name,index) {
       ...
       /* 좌표 */
       var _nx = x, _ny = y,
       apikey = "N3pw1Kne0KhxwSKXZpC37OAa44kzvmXeLx71eL7qRW75K63A%2BiXE1wp2lB4lG3nfN3A1wQlmXxESpoW0UHgzDQ%3D%3D",    
      ...
      $.ajax({
          ...
          ,success: function(msg) {
             ...
             console.log(msg.response);
                ...
                console.log("weather_inl" + index);
                $('.weather_inl_' + index).html('<img src="${cpath}/resources/weatherImg/' + weather + '.png" width="95px" height="90px">');
