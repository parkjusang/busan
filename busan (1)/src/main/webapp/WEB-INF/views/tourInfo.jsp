...
<body>
   ...
   // 10대,20대... 그래프 비율
      const agePercent = function(){
         ...
         //   console.log('총  : ' + allSum);
            
          //  console.log('퍼센트 : ' + (((plus)/allSum)*100));
          //  console.log('퍼센트 : ' + (((plus1)/allSum)*100));
          //  console.log('퍼센트 : ' + (((plus2)/allSum)*100));
          //  console.log('퍼센트 : ' + (((plus3)/allSum)*100));
          //  console.log('퍼센트 : ' + (((plus4)/allSum)*100));
        ...
        //    fifeoper.style.backgroundColor = '#ffffff';
         ...
         //   console.log('10대 : ' + teen.length);
         //   console.log('20대 : ' + twen.length);
         //   console.log('30대 : ' + thir.length);
         //   console.log('40대 : ' + four.length);
         //   console.log('50대 : ' + fift.length);
